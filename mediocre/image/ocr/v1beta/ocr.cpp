...
namespace mediocre::image::ocr::v1beta {
    ...
    const char *OcrServiceImpl::GetCharacters(const Image &image, const GetCharactersParams &params) {
    ...
    const char *OcrServiceImpl::GetCharacters(const cv::Mat &input, const GetCharactersParams &params) {
